...
export default function ActionButton({business}) {
    ...
    const actionButtonMenu = [
        {
            id:1,
            name:'Call',
            icon:require('./../../assets/images/call.png'),            // for accessing something from the local we need to use require
        ...
        },
        {
            id:3,
            name:'Web',
            icon:require('./../../assets/images/web.jpg'),
    ...
    const OnPressHandle = (item) => {
        ...
        {
            Share.share({
                message:business?.name + "\n Address:" + business?.address + "\n Find more details on BizFinder App !"
            })
            return ;
        }
